...
namespace WorkloadWebApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            // Create admin account using configuration in the Web.config if it does not exist
            CreateAdminIfNeeded();
        ...
        public ActionResult LogOff()
        {
            ...
            return RedirectToAction("Index", "Workload");
        }
        ...
        private void CreateAdminIfNeeded()
        {
            ...
            {
                var result = !RoleManager.RoleExists("Administrator");
