...
namespace WorkloadWebApp.Controllers
{
    public class AdminController : Controller
    {
        ...
        private ExpandedUserDTO GetUser(string UserName)
        {
            ...
            ExpandedUserDTO colUserRoleDTO = new ExpandedUserDTO();

            colUserRoleDTO.UserName = user.UserName;
            colUserRoleDTO.Email = user.Email;
            colUserRoleDTO.LockoutEndDateUtc = user.LockoutEndDateUtc;

            return colUserRoleDTO;
        }
        #endregion
